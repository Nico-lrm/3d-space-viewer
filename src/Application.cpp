...
void Application::InitSpaceRenderer()
{
    ...
    this->m_ModelManager->createModel("mercury", "mercury/mercury_high.gltf", true);
    this->m_ModelManager->createModel("venus", "venus/venus_high.gltf", true);
    this->m_ModelManager->createModel("earth", "earth/earth_high.gltf", false);
    this->m_ModelManager->createModel("mars", "mars/mars_high.gltf", true);
    this->m_ModelManager->createModel("jupiter", "jupiter/jupiter_high.gltf", true);
    this->m_ModelManager->createModel("saturn", "saturn/saturn_high.gltf", true);
    this->m_ModelManager->createModel("uranus", "uranus/uranus_high.gltf", true);
    this->m_ModelManager->createModel("neptune", "neptune/neptune_high.gltf", true);
    this->m_ModelManager->createModel("moon", "moon/moon_high.gltf", true);
    ...
    this->m_SceneManager->addCelestialActiveScene("Moon", m_ModelManager->getElementByName("moon"), m_ShaderManager->getElementByName("planet"), 0.0615f, 0.009f, m_SceneManager->getCelestialActiveScene("Earth"), glm::vec3(0.1f, 0.f, 0.0f));
    ...
    this->m_SceneManager->addAsteroidActiveScene("KuiperBelt", 180.f, 27.5f, 12500, m_SceneManager->getCelestialActiveScene("Sun"), m_ShaderManager->getElementByName("asteroid"), m_ModelManager->getElementByName("asteroid"), 25.0);
